    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid ">
            <div class="row ">
                ...
                <div class="col-sm-11 col-md-6 col-lg-10 col-xl-12  mx-auto" style="background-color: #696969;">
                        ...
                        @if((Auth()->user()->userType==="chairman")||(Auth()->user()->userType==="treasurer"))
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                    <!-- <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad, voluptate fugiat quam quia porro doloremque explicabo architecto placeat dolor quasi at harum perspiciatis sequi ut molestias deleniti quisquam eligendi magnam?</p> -->
                                    </div>
                                    <div class="col-md-6">
                                        @php
                                            $Allexpenses = DB::table("expenses")->where("expenses.status", "=", "approved")->sum("budget");
