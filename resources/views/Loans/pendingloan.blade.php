                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-md-flex align-items-center">
                                <div>
                                    <h6 class="card-subtitle">Pending Loans</h6>
                                    <h6>Total Amount: <strong class="saved">__ UGX</strong>, Money in Loans : <strong class="runningloan">__ UGX</strong></h6>
                                    <h6> Borrowable Money : <strong class="borrow">__ UGX</strong></h6>
                                </div>
                                <div class="ml-auto">
                                    <div class="dl">
                                        <input type="month" class="pendingLoan"name="month" id="monthloan" />
                                    </div>
                                </div>
                            </div>
                            <!-- title -->
                        ...
                        <div class="table-responsive">
                            <table class="table v-middle">
                                ...
                                {{-- data from jQuery --}}
                                <tbody class="pendingloan-tbody"></tbody>
                            </table>
                        </div>
                    </div>
                </div>
